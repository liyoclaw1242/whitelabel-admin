  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "data-active:bg-outline-bg data-active:text-foreground data-active:border-active-tab-border dark:data-active:border-input dark:data-active:bg-input/30",
